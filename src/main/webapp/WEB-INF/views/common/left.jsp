	...
	<%--
		...
		kr.or.ddit.user.controller.AllUser
			doGet(){
				...
				3. webapp/user/allUser.jsp로 응답을 생성하도록 forward를 생성
				   allUser.jsp는 user.html을 참고해서 만들면 되고
				   header.jsp, left.jsp를 재활용해서 만들면 됨
				   
				   user.html의 사용자 정보를 표현하는 테이블 태그의 tr부분을 request에 저장된 
				   userList속성값으로 동적 생성하여 화면에 출력
